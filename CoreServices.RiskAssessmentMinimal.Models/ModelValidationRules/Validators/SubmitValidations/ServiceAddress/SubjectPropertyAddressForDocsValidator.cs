...
namespace Edrs.ActionListenerService.Models.ModelValidationRules.Validators.SubmitValidations.ServiceAddress
{
    ...
    public class SubjectPropertyAddressForDocsValidator : AddressForDocumentsValidatorBase<SubjectPropertyAddress>
    {
        public SubjectPropertyAddressForDocsValidator()
        {
        }
    }
}
